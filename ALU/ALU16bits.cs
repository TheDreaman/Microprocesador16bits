...
namespace ALU
{
    public class ALU16bits
    {
        ...
        public void Resta(int a7, int a6, int a5, int a4, int a3, int a2, int a1, int a0, int b7, int b6, int b5, int b4, int b3, int b2, int b1, int b0) //Sumador completo 8bits
        {
            ...
            int w = AND(b0, Cin);
            Auxiliar.Auxiliar.RR0 = XOR(x, Cin);  //Resultado 0
            ...
            z = AND(NOT(a1), Cin);
            w = AND(b1, Cin);
            Auxiliar.Auxiliar.RR1 = XOR(x, Cin);  //Resultado 1
            ...
            z = AND(NOT(a2), Cin);
            w = AND(b2, Cin);
            Auxiliar.Auxiliar.RR2 = XOR(x, Cin);  //Resultado 2
            ...
            z = AND(NOT(a3), Cin);
            w = AND(b3, Cin);
            Auxiliar.Auxiliar.RR3 = XOR(x, Cin);  //Resultado 3
            ...
            z = AND(NOT(a4), Cin);
            w = AND(b4, Cin);
            Auxiliar.Auxiliar.RR4 = XOR(x, Cin);  //Resultado 4
            ...
            z = AND(NOT(a5), Cin);
            w = AND(b5, Cin);
            Auxiliar.Auxiliar.RR5 = XOR(x, Cin);  //Resultado 5
            ...
            z = AND(NOT(a6), Cin);
            w = AND(b6, Cin);
            Auxiliar.Auxiliar.RR6 = XOR(x, Cin);  //Resultado 6
            ...
            z = AND(NOT(a7), Cin);
            w = AND(b7, Cin);
            Auxiliar.Auxiliar.RR7 = XOR(x, Cin);  //Resultado 7
